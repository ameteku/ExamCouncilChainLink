...
function Login(props){
    ...
    const [currentID, updateMarkerID] = React.useState("");
    const [currentPassword, updateMarkerPassword] = React.useState("");

   function handleIDChange(event){
       updateMarkerID(event.target.value);
   }

   function handlePasswordChange(event){
       updateMarkerPassword(event.target.value);
   }
    ...
    return (
        <div className="login text-center">
            <form class="form-signin">
                ...
                <input type="text" onChange={handleIDChange} value={currentID} id="inputEmail" class="form-control" placeholder="Marker ID" required autofocus/>
