...
function Register(props){
    function registerUser(event){
        props.updateUserInfo(currentInfo.studentID, currentInfo.firstName,
             currentInfo.lastName,currentInfo.password)
    }
   ...
   //console.log(currentInfo);
    ...
    return (
      ...
      <input type="text" id="studentID" onChange={handleInfoChange} class="form-control" placeholder="Student ID" required autofocus/>
